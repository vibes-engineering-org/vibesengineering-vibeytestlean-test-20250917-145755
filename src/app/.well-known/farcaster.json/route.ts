export async function GET() {
  return Response.json({
    accountAssociation: {
      ...
      signature:
        "MHg3MTgxZTY0ZTZjODNiOTBmM2IyMGNhNzA1NzI0YzI4MjcxZGRiNWEwOTkxNmQxODcwZjAxMWRlZjkyZDNkMWNmNmE1ZTZmYTY1Y2NlODEzODBlYTFiNTg0YjRhY2NhMDFkMTAxYzIxZThiYmIzYjIxODFkNzAxZDNlMWUyNDNlZTFj",
    },
    miniapp: {
      version: "1",
